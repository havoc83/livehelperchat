...
CREATE TABLE "lh_departament" (
    ...
    "mod_start_hour" integer NOT NULL,
    "mod_end_hour" integer NOT NULL,
    "tud_start_hour" integer NOT NULL,
    "tud_end_hour" integer NOT NULL,
    "wed_start_hour" integer NOT NULL,
    "wed_end_hour" integer NOT NULL,
    "thd_start_hour" integer NOT NULL,
    "thd_end_hour" integer NOT NULL,
    "frd_start_hour" integer NOT NULL,
    "frd_end_hour" integer NOT NULL,
    "sad_start_hour" integer NOT NULL,
    "sad_end_hour" integer NOT NULL,
    "sud_start_hour" integer NOT NULL,
    "sud_end_hour" integer NOT NULL,    
    ...
    "inform_close_all" integer NOT NULL,
    "pending_max" integer NOT NULL,
    "pending_group_max" integer NOT NULL,
    "inform_close_all_email" integer NOT NULL,
    "product_configuration" integer NOT NULL,
    PRIMARY KEY ("id")
);
...
INSERT INTO "lh_users" VALUES (1,'admin','44f7fa28bdd2ffbd74dbde0684728bb6dc132178','admin@example.com','','Support','Support','','','','','','','','',0,0,0,0,0,0,0,1,0);
...
CREATE TABLE lh_abstract_survey (
	  ...
	  "max_stars_1_pos" integer NOT NULL,
	  "max_stars_2_title" varchar(250) NOT NULL,
	  "max_stars_2_pos" integer NOT NULL,
	  "max_stars_2" integer NOT NULL,
	  "max_stars_3_title" varchar(250) NOT NULL,
	  "max_stars_3_pos" integer NOT NULL,
	  "max_stars_3" integer NOT NULL,
	  "max_stars_4_title" varchar(250) NOT NULL,
	  "max_stars_4_pos" integer NOT NULL,
	  "max_stars_4" integer NOT NULL,
	  "max_stars_5_title" varchar(250) NOT NULL,
	  "max_stars_5_pos" integer NOT NULL,
	  "max_stars_5" integer NOT NULL,
	  "question_options_1" varchar(250) NOT NULL,
	  "question_options_1_items" text NOT NULL,
	  "question_options_1_pos" integer NOT NULL,
	  "question_options_2" varchar(250) NOT NULL,
	  "question_options_2_items" text NOT NULL,
	  "question_options_2_pos" integer NOT NULL,
	  "question_options_3" varchar(250) NOT NULL,
	  "question_options_3_items" text NOT NULL,
	  "question_options_3_pos" integer NOT NULL,
	  "question_options_4" varchar(250) NOT NULL,
	  "question_options_4_items" text NOT NULL,
	  "question_options_4_pos" integer NOT NULL,
	  "question_options_5" varchar(250) NOT NULL,
	  "question_options_5_items" text NOT NULL,
	  "question_options_5_pos" integer NOT NULL,
	  "question_plain_1" text NOT NULL,
	  "question_plain_1_pos" integer NOT NULL,
	  "question_plain_2" text NOT NULL,
	  "question_plain_2_pos" integer NOT NULL,
	  "question_plain_3" text NOT NULL,
	  "question_plain_3_pos" integer NOT NULL,
	  "question_plain_4" text NOT NULL,
	  "question_plain_4_pos" integer NOT NULL,
	  "question_plain_5" text NOT NULL,
	  "question_plain_5_pos" integer NOT NULL,
	  "max_stars_1_enabled" integer NOT NULL,
	  "max_stars_2_enabled" integer NOT NULL,
	  "max_stars_3_enabled" integer NOT NULL,
	  "max_stars_4_enabled" integer NOT NULL,
	  "max_stars_5_enabled" integer NOT NULL,
	  "question_options_1_enabled" integer NOT NULL,
	  "question_options_2_enabled" integer NOT NULL,
	  "question_options_3_enabled" integer NOT NULL,
	  "question_options_4_enabled" integer NOT NULL,
	  "question_options_5_enabled" integer NOT NULL,
	  "question_plain_1_enabled" integer NOT NULL,
	  "question_plain_2_enabled" integer NOT NULL,
	  "question_plain_3_enabled" integer NOT NULL,
	  "question_plain_4_enabled" integer NOT NULL,
	  "question_plain_5_enabled" integer NOT NULL,
	  "max_stars_1" integer NOT NULL,
	  "max_stars_1_req" integer NOT NULL,
	  "max_stars_2_req" integer NOT NULL,
	  "max_stars_3_req" integer NOT NULL,
	  "max_stars_4_req" integer NOT NULL,
	  "max_stars_5_req" integer NOT NULL,
	  "question_options_1_req" integer NOT NULL,
	  "question_options_2_req" integer NOT NULL,
	  "question_options_3_req" integer NOT NULL,
	  "question_options_4_req" integer NOT NULL,
	  "question_options_5_req" integer NOT NULL,
	  "question_plain_1_req" integer NOT NULL,
	  "question_plain_2_req" integer NOT NULL,
	  "question_plain_3_req" integer NOT NULL,
	  "question_plain_4_req" integer NOT NULL,
	  "question_plain_5_req" integer NOT NULL,
	  PRIMARY KEY ("id")
);
...
CREATE TABLE lh_abstract_survey_item (
	  ...
	  "max_stars_4" integer NOT NULL,
	  "max_stars_5" integer NOT NULL,
	  "question_options_1" integer NOT NULL,
	  "question_options_2" integer NOT NULL,
	  "question_options_3" integer NOT NULL,
	  "question_options_4" integer NOT NULL,
	  "question_options_5" integer NOT NULL,
	  "question_plain_1" text NOT NULL,
	  "question_plain_2" text NOT NULL,
	  "question_plain_3" text NOT NULL,
	  "question_plain_4" text NOT NULL,
...
CREATE INDEX custom_work_dep_id ON lh_departament_custom_work_hours (dep_id);
...
CREATE TABLE lh_group_work (  id int NOT NULL DEFAULT NEXTVAL ('lh_group_work_seq'),  group_id int NOT NULL, group_work_id int NOT NULL, PRIMARY KEY (id));
...
CREATE INDEX abstract_user_id ON lh_abstract_rest_api_key (user_id);
...
-- Sequences --
DROP SEQUENCE IF EXISTS SEQUENCE lh_canned_msg_tag_link_id_seq;
CREATE SEQUENCE lh_canned_msg_tag_link_id_seq;
SELECT setval('lh_canned_msg_tag_link_id_seq', max(id)) FROM lh_canned_msg_tag_link;
ALTER TABLE "lh_canned_msg_tag_link" ALTER COLUMN "id" SET DEFAULT nextval('lh_canned_msg_tag_link_id_seq');

DROP SEQUENCE IF EXISTS SEQUENCE lh_canned_msg_tag_id_seq;
CREATE SEQUENCE lh_canned_msg_tag_id_seq;
SELECT setval('lh_canned_msg_tag_id_seq', max(id)) FROM lh_canned_msg_tag;
ALTER TABLE "lh_canned_msg_tag" ALTER COLUMN "id" SET DEFAULT nextval('lh_canned_msg_tag_id_seq');

DROP SEQUENCE IF EXISTS SEQUENCE lh_abstract_product_departament_id_seq;
CREATE SEQUENCE lh_abstract_product_departament_id_seq;
SELECT setval('lh_abstract_product_departament_id_seq', max(id)) FROM lh_abstract_product_departament;
ALTER TABLE "lh_abstract_product_departament" ALTER COLUMN "id" SET DEFAULT nextval('lh_abstract_product_departament_id_seq');


DROP SEQUENCE IF EXISTS SEQUENCE lh_abstract_auto_responder_chat_id_seq;
CREATE SEQUENCE lh_abstract_auto_responder_chat_id_seq;
SELECT setval('lh_abstract_auto_responder_chat_id_seq', max(id)) FROM lh_abstract_auto_responder_chat;
ALTER TABLE "lh_abstract_auto_responder_chat" ALTER COLUMN "id" SET DEFAULT nextval('lh_abstract_auto_responder_chat_id_seq');

DROP SEQUENCE IF EXISTS SEQUENCE lh_departament_limit_group_member_id_seq;
CREATE SEQUENCE lh_departament_limit_group_member_id_seq;
SELECT setval('lh_departament_limit_group_member_id_seq', max(id)) FROM lh_departament_limit_group_member;
ALTER TABLE "lh_departament_limit_group_member" ALTER COLUMN "id" SET DEFAULT nextval('lh_departament_limit_group_member_id_seq');

DROP SEQUENCE IF EXISTS SEQUENCE lh_departament_limit_group_id_seq;
CREATE SEQUENCE lh_departament_limit_group_id_seq;
SELECT setval('lh_departament_limit_group_id_seq', max(id)) FROM lh_departament_limit_group;
ALTER TABLE "lh_departament_limit_group" ALTER COLUMN "id" SET DEFAULT nextval('lh_departament_limit_group_id_seq');

DROP SEQUENCE IF EXISTS SEQUENCE lh_abstract_proactive_chat_event_id_seq;
CREATE SEQUENCE lh_abstract_proactive_chat_event_id_seq;
SELECT setval('lh_abstract_proactive_chat_event_id_seq', max(id)) FROM lh_abstract_proactive_chat_event;
ALTER TABLE "lh_abstract_proactive_chat_event" ALTER COLUMN "id" SET DEFAULT nextval('lh_abstract_proactive_chat_event_id_seq');

DROP SEQUENCE IF EXISTS lh_abstract_proactive_chat_invitation_event_id_seq;
CREATE SEQUENCE lh_abstract_proactive_chat_invitation_event_id_seq;
SELECT setval('lh_abstract_proactive_chat_invitation_event_id_seq', max(id)) FROM lh_abstract_proactive_chat_invitation_event;
ALTER TABLE "lh_abstract_proactive_chat_invitation_event" ALTER COLUMN "id" SET DEFAULT nextval('lh_abstract_proactive_chat_invitation_event_id_seq');

DROP SEQUENCE IF EXISTS lh_abstract_proactive_chat_variables_id_seq;
CREATE SEQUENCE lh_abstract_proactive_chat_variables_id_seq;
SELECT setval('lh_abstract_proactive_chat_variables_id_seq', max(id)) FROM lh_abstract_proactive_chat_variables;
ALTER TABLE "lh_abstract_proactive_chat_variables" ALTER COLUMN "id" SET DEFAULT nextval('lh_abstract_proactive_chat_variables_id_seq');

DROP SEQUENCE IF EXISTS lh_abstract_survey_item_id_seq;
CREATE SEQUENCE lh_abstract_survey_item_id_seq;
SELECT setval('lh_abstract_survey_item_id_seq', max(id)) FROM lh_abstract_survey_item;
ALTER TABLE "lh_abstract_survey_item" ALTER COLUMN "id" SET DEFAULT nextval('lh_abstract_survey_item_id_seq');

DROP SEQUENCE IF EXISTS lh_chat_paid_id_seq;
CREATE SEQUENCE lh_chat_paid_id_seq;
SELECT setval('lh_chat_paid_id_seq', max(id)) FROM lh_chat_paid;
ALTER TABLE "lh_chat_paid" ALTER COLUMN "id" SET DEFAULT nextval('lh_chat_paid_id_seq');

DROP SEQUENCE IF EXISTS lh_admin_theme_id_seq;
CREATE SEQUENCE lh_admin_theme_id_seq;
SELECT setval('lh_admin_theme_id_seq', max(id)) FROM lh_admin_theme;
ALTER TABLE "lh_admin_theme" ALTER COLUMN "id" SET DEFAULT nextval('lh_admin_theme_id_seq');

DROP SEQUENCE IF EXISTS lh_abstract_survey_id_seq;
CREATE SEQUENCE lh_abstract_survey_id_seq;
SELECT setval('lh_abstract_survey_id_seq', max(id)) FROM lh_abstract_survey;
ALTER TABLE "lh_abstract_survey" ALTER COLUMN "id" SET DEFAULT nextval('lh_abstract_survey_id_seq');

DROP SEQUENCE IF EXISTS lh_users_online_session_id_seq;
CREATE SEQUENCE lh_users_online_session_id_seq;
SELECT setval('lh_users_online_session_id_seq', max(id)) FROM lh_users_online_session;
ALTER TABLE "lh_users_online_session" ALTER COLUMN "id" SET DEFAULT nextval('lh_users_online_session_id_seq');

DROP SEQUENCE IF EXISTS lh_departament_group_member_id_seq;
CREATE SEQUENCE lh_departament_group_member_id_seq;
SELECT setval('lh_departament_group_member_id_seq', max(id)) FROM lh_departament_group_member;
ALTER TABLE "lh_departament_group_member" ALTER COLUMN "id" SET DEFAULT nextval('lh_departament_group_member_id_seq');

DROP SEQUENCE IF EXISTS lh_departament_group_id_seq;
CREATE SEQUENCE lh_departament_group_id_seq;
SELECT setval('lh_departament_group_id_seq', max(id)) FROM lh_departament_group;
ALTER TABLE "lh_departament_group" ALTER COLUMN "id" SET DEFAULT nextval('lh_departament_group_id_seq');

DROP SEQUENCE IF EXISTS lh_departament_group_user_id_seq;
CREATE SEQUENCE lh_departament_group_user_id_seq;
SELECT setval('lh_departament_group_user_id_seq', max(id)) FROM lh_departament_group_user;
ALTER TABLE "lh_departament_group_user" ALTER COLUMN "id" SET DEFAULT nextval('lh_departament_group_user_id_seq');
...
DROP SEQUENCE IF EXISTS lh_abstract_product_id_seq;
CREATE SEQUENCE lh_abstract_product_id_seq;
SELECT setval('lh_abstract_product_id_seq', max(id)) FROM lh_abstract_product;
ALTER TABLE "lh_abstract_product" ALTER COLUMN "id" SET DEFAULT nextval('lh_abstract_product_id_seq');
...
CREATE INDEX chat_id_auto_responder ON lh_abstract_auto_responder_chat (chat_id);
...
CREATE INDEX survey_id ON lh_abstract_survey_item USING btree(survey_id);
CREATE INDEX chat_id_survey_item ON lh_abstract_survey_item USING btree(chat_id);
CREATE INDEX user_id_survey_item ON lh_abstract_survey_item USING btree(user_id);
CREATE INDEX dep_id ON lh_abstract_survey_item USING btree(dep_id);
CREATE INDEX ftime ON lh_abstract_survey_item USING btree(ftime);
CREATE INDEX max_stars_1 ON lh_abstract_survey_item USING btree(max_stars_1);
CREATE INDEX max_stars_2 ON lh_abstract_survey_item USING btree(max_stars_2);
CREATE INDEX max_stars_3 ON lh_abstract_survey_item USING btree(max_stars_3);
CREATE INDEX max_stars_4 ON lh_abstract_survey_item USING btree(max_stars_4);
CREATE INDEX max_stars_5 ON lh_abstract_survey_item USING btree(max_stars_5);
CREATE INDEX question_options_1 ON lh_abstract_survey_item USING btree(question_options_1);
CREATE INDEX question_options_2 ON lh_abstract_survey_item USING btree(question_options_2);
CREATE INDEX question_options_3 ON lh_abstract_survey_item USING btree(question_options_3);
CREATE INDEX question_options_4 ON lh_abstract_survey_item USING btree(question_options_4);
CREATE INDEX question_options_5 ON lh_abstract_survey_item USING btree(question_options_5);
CREATE INDEX hash ON lh_chat_paid USING btree(hash);
CREATE INDEX chat_id_paid ON lh_chat_paid USING btree(chat_id);
CREATE INDEX user_id_lactivity ON lh_users_online_session USING btree(user_id,lactivity);
CREATE INDEX dep_group_id ON lh_departament_group_member USING btree(dep_group_id);
