	...
	if ($is_activated == true || $is_proactive_based == true) {
		...
		if ($chat->number_in_queue > 1) {
			...
			if ($theme !== false && $theme->pending_join != '') {
				...
				$status = erTranslationClassLhTranslation::getInstance ()->getTranslation ( 'chat/checkchatstatus', 'To initiate contact with a live agent, please type your name and your question or comment. The first available agent will respond momentarily' );
			}
		}
	} else {
